...
LiveValidationForm.getInstance = function(element){
  ...
  var id = el.getAttribute('id'); // no link to input with name="id"
  if(!LiveValidationForm.instances[id]) LiveValidationForm.instances[id] = new LiveValidationForm(el);
  return LiveValidationForm.instances[id];
}
