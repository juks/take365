...
return [
    ...
    '{user} profile page'									        => 'Профиль {user}',
    ...
    '{n,plural,=0{No comments} =1{One Comment} other{# Comments}}'  => '{n,plural,=0{Нет комментариев} one{# Комментарий} few{# Комментария} many{# Комментариев} other{# Комментариев}}'
];
