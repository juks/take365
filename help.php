...
<p>Для каждой истории ведётся статистика, прилагается удобный инструмент для поддержания актуальности календаря. Словом всё, что необходимо для того, чтобы далёкая цель не&nbsp;выглядела такой уж&nbsp;неприступной и&nbsp;сложной.</p>
...
<p>Да, возможно! Сотни счастливчиков нашли способ организовать себя в&nbsp;непростом, но&nbsp;стоящем деле. Полностью завершённые проекты можно увидеть в&nbsp;интернете, но&nbsp;дайте нам срок!</p>
<p>Мы составили <a href="{{ $base_full_url }}help/howto/">несколько советов</a> &laquo;Как правильно подойти к&nbsp;делу и&nbsp;не&nbsp;разменяться на&nbsp;ерунду&raquo;.</p>
<h2>Правила</h2>
...
<p>Три приятеля, <a href="http://juks.ru">Игорь</a>, <a href="http://lusever.ru">Паша</a> и <a href="http://ioracle.ru">Серёжа</a> сделали этот сайт в&nbsp;своё свободное время.</p>