...
<header class="article-header">
  <h1 class="article-title"><?php if ($owner->thisIsMe): ?>Привет, <a href="<?= $owner->urlProfile ?>"><?= $owner->fullnameFilled ?></a>!<?php else: ?>Истории <a href="<?= $owner->urlProfile ?>"><?= $owner->fullnameFilled ?></a><?php endif ?></h1>
  <?php if ($canCreate): ?>
