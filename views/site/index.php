...
<main class="main">
  <article class="article">
    <section class="article-section">
      <h1 class="article-title">По одной фотографии на каждый день</h1>
    ...
    <section class="article-section">
      <h2 class="article-title">Идея</h2>
    ...
    <section class="article-section">
      <h2 class="article-title">Зачем это нужно?</h2>
    ...
    <section class="article-section">
      <h2 class="article-title">Это вообще возможно?</h2>
      <p class="article-text">Да, возможно! Сотни счастливчиков нашли способ организовать себя в непростом, но стоящем деле. Мы составили несколько советов «Как правильно подойти к делу и не разменяться на ерунду».</p>
    </section>
    <section class="article-section">
      <h2 class="article-title">Правила</h2>
    ...
    <section class="article-section">
      <h2 class="article-title">Чьих это рук дело?</h2>
